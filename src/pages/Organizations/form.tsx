                    ...
                    <div className="card mb-4">
                        <div className="card-body">
                            <form onSubmit={handleSubmit}>
                                ...
                                {renderInput("email", "Correo electrónico:", "text", "user@veekls.com", "email2", "bx-envelope", "@veekls.com", "Puedes usar letras, números y puntos", handleChange, userState.email)}
